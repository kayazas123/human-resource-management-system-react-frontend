...
export default function AttendanceReports(props) {
    ...
    useEffect(() => {
        var config = {
            method: 'get',
            url: 'http://localhost:9090/v1/company-reports/2',
            headers: {
            ...
            <Grid item md={6}>
                <Grid container direction='column' justify='center' alignItems='center' spacing={3}>
                    ...
                    <Grid item xs={12} className={classes.noReportDetailsContainer}>
                        <Typography variant='body' className={classes.noReportDetails} align='center'>Payroll Reports For Your Workforce Are Generated At The Beginning Of Each Month (For The Month Before).</Typography>
                    </Grid>
                    <Grid item xs={12} className={classes.noReportDetailsContainer}>
